      ...
      <div className="print-area bg-white p-8 rounded-xl border border-border max-w-3xl">
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Official IT Asset Accountability Document
          </p>
        </div>
        ...
        <div className="border-t border-border pt-4 mb-4">
          <h3 className="text-sm font-bold mb-3">Equipment Information</h3>
        ...
        <div className="border-t border-border pt-6 mt-6">
          <p className="text-xs text-muted-foreground mb-8">
            I, the undersigned, acknowledge full accountability for the above-listed
            IT equipment assigned to me. I understand that I am responsible for its
            safekeeping, proper use, and timely return. I agree to report any damage,
            loss, or malfunction immediately to the IT Department. Failure to return
            the equipment in acceptable condition may result in financial liability.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="border-b border-foreground mb-1 h-8" />
              <p className="text-xs font-medium">IT Department</p>
              <p className="text-[10px] text-muted-foreground">Signature / Date</p>
            </div>

            <div className="text-center">
              <div className="border-b border-foreground mb-1 h-8" />
              <p className="text-xs font-medium">Noted By (Manager)</p>
              <p className="text-[10px] text-muted-foreground">Signature / Date</p>
            </div>
          </div>
        </div>
